...
// List lists all ImageVerificationPolicies in the indexer.
func (s *imageVerificationPolicyLister) List(selector labels.Selector) (ret []*v1alpha1.ImageVerificationPolicy, err error) {
...
func (s imageVerificationPolicyNamespaceLister) Get(name string) (*v1alpha1.ImageVerificationPolicy, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("imageverificationpolicy"), name)
	}
	return obj.(*v1alpha1.ImageVerificationPolicy), nil
}
