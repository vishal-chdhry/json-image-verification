...
var imageverificationpoliciesKind = v1alpha1.SchemeGroupVersion.WithKind("ImageVerificationPolicy")
...
func (c *FakeImageVerificationPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ImageVerificationPolicyList, err error) {
	...
	list := &v1alpha1.ImageVerificationPolicyList{ListMeta: obj.(*v1alpha1.ImageVerificationPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.ImageVerificationPolicyList).Items {
