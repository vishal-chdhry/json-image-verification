...
import (
	...
	scheme "github.com/vishal-chdhry/cloud-image-verification/pkg/client/clientset/versioned/scheme"
...
type ImageVerificationPolicyInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ImageVerificationPolicyList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ImageVerificationPolicy, err error)
	ImageVerificationPolicyExpansion
}
...
func (c *imageVerificationPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ImageVerificationPolicyList, err error) {
...
func (c *imageVerificationPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *imageVerificationPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
